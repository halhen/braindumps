...
Det Lotteriinspektionen dock saknar är individuella spelares information. Den sammanslagna statistik man får tvingar fram ett ett makroekonomiskt perspektiv på spelmarknaden. Så här mycket omsätter svenskarna, och dividerat med hur många vi är så blir det så här mycket per person.
...
SWELOGS uppmätta medelvärde och standardavvikelse innehåller all information vi behöver för att skapa vår modell. Innan vi tittar på vad den säger, är det god sed att undersöka om våra antaganden verkar rimliga. Vi låter därför modellen uppskatta ett antal mätetal och jämför med verkligheten för att se hur väl de stämmer.
